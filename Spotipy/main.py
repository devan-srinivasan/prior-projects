...
#                'key': 0,
#                'liveness': 0,
#                'gen_mode': 'artist pref'}
# # track_list = spotify_methods.pull_playlist('Gimme some Rammstein', graph, ALL_SONGS)
# track_list = [spotify_methods.find_track_options('woah', graph, all_songs, 'EDEN Project')[0]]
# res = make_playlist(track_list, preferences, graph, all_songs)
# new = computations.par_gen(graph, track_list, 2, preferences)
