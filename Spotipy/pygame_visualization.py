...
def handle_typing(input_string: str, key: str) -> str:
    """
    handle changing the input_string (What the user has typed in the pygame window) when the user
    types.
...
def handle_return_press(genre_graph: GenreGraph, screen: pygame.Surface,
    ...
    """
    return what the values of the curr_genre, input_str and curr_vert_pos should be when
